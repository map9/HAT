/**
 * ChineseCalendarHtmlRender.ts
 * ChineseCalendarHtmlRender 中国农历多语言格式化输出Html类。
 ...
 * 
 * - 本文档变更：
 *   1. 将 ChineseCalendar 的 exportYear 的输出数据，格式化为 html；
 *   2. 拆分 calendar.js html格式化输出相关操作到本文件；
 *   3. 合并不同年份的提示和警告信息；
 *   4. 支持 Typescript。
 * 
