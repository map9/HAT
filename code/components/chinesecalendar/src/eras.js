...
function eraNameHant(year, calender = null) {
  ...
  if (year > 385.5 && year < 590.5 && (calender == "SouthNorth.North.NorthernWei" || calender == "SouthNorth.North.WesternWei" || calender == "SouthNorth.North.NorthernZhou" || calender == "SouthNorth.North.Sui")) {
    eras = [
      ...
      {y: 424, e: "北魏太武帝始光"},
      {y: 417, e: "北魏明元帝泰常", offset: 1},
      {y: 416, e: "北魏明元帝神瑞三年/泰常元年", offset: -1},
      {y: 414, e: "北魏明元帝神瑞"},
      {y: 410, e: "北魏明元帝永興", offset: 1},
  ...
  if (year >= 1368 && year <= 1644) {
    eras = [
      ...
      {y: 1628, e: "明思宗崇禎"},
      {y: 1621, e: "明熹宗天啟"},
      {y: 1620, e: "明神宗萬曆四十八年/明光宗泰昌元年", offset: -1},
      {y: 1573, e: "明神宗萬曆"},
      {y: 1567, e: "明穆宗隆慶"},
      {y: 1522, e: "明世宗嘉靖"},
      {y: 1506, e: "明武宗正德"},
  ...
  if (year >= 1644 && year <= 1685 && (calender == "Qing.SouthernMing" || calender == "Qing.Zheng")) {
    eras = [
      ...
      {y: 1654, e: "南明永曆", offset: 7},
      {y: 1653, e: "南明永曆七年/魯王監國八年", offset: -1},
      {y: 1652, e: "南明永曆六年/魯王監國七年", offset: -1},
      {y: 1651, e: "南明永曆五年/魯王監國六年", offset: -1},
      {y: 1650, e: "南明永曆四年/魯王監國五年", offset: -1},
      {y: 1649, e: "南明永曆三年/魯王監國四年", offset: -1},
      {y: 1648, e: "南明永曆二年/魯王監國三年", offset: -1},
      {y: 1647, e: "南明永曆元年/魯王監國二年", offset: -1},
      {y: 1646, e: "南明隆武二年/魯王監國元年", offset: -1},
      {y: 1645, e: "南明弘光元年/隆武元年", offset: -1},
      {y: 1628, e: "明崇禎"},
    ];
  }
...
function eraNameHans(year, calender = null) {
  // set up an array of objects to store era name information
  let eras = [
    {y: 1912, e: ""},
    {y: -99999, e: ""},
  ...
  if (year >= 1368 && year <= 1644) {
    eras = [
      ...
      {y: 1628, e: "明思宗崇祯"},
      {y: 1621, e: "明熹宗天启"},
      {y: 1620, e: "明神宗万历四十八年/明光宗泰昌元年", offset: -1},
      {y: 1573, e: "明神宗万历"},
      {y: 1567, e: "明穆宗隆庆"},
      {y: 1522, e: "明世宗嘉靖"},
      {y: 1506, e: "明武宗正德"},
  ...
  if (year >= 1644 && year <= 1685 && (calender == "Qing.SouthernMing" || calender == "Qing.Zheng")) {
    eras = [
      ...
      {y: 1654, e: "南明永历", offset: 7},
      {y: 1653, e: "南明永历七年/鲁王监国八年", offset: -1},
      {y: 1652, e: "南明永历六年/鲁王监国七年", offset: -1},
      {y: 1651, e: "南明永历五年/鲁王监国六年", offset: -1},
      {y: 1650, e: "南明永历四年/鲁王监国五年", offset: -1},
      {y: 1649, e: "南明永历三年/鲁王监国四年", offset: -1},
      {y: 1648, e: "南明永历二年/鲁王监国三年", offset: -1},
      {y: 1647, e: "南明永历元年/鲁王监国二年", offset: -1},
      {y: 1646, e: "南明隆武二年/鲁王监国元年", offset: -1},
      {y: 1645, e: "南明弘光元年/隆武元年", offset: -1},
      {y: 1628, e: "明崇祯"},
    ];
  }
 ...
 * @returns 年号。
 */
export function eraName(lang, year, calender = null) {
  if (lang == 'zh-Hans') {
