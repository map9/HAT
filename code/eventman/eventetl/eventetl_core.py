...
3.事件按在文本中出现的先后顺序提取。
4.事件发生的时间提取要参考上一个文献片段“最后记录的历史时间”，综合本文献片段中的年号、月份、干支日，要尽可能补齐缺失的部分，精确到年号、月份和干支日。不要出现以下的时间错误：
  - "十六年"，没有年号， 应该补全年号："建安十六年"；
  - "建安十八年丙申"，没有月份，应该补全月份："建安十八年五月丙申"；
  - "延康二十五年二月丁卯"，没有干支日，原文："二月丁卯，葬高陵。"，有干支日，应该补全干支日："延康二十五年二月丁卯"。
5.事件参与的人物为多个时，务必要全面完整，不能遗失；如果找不到人物时，考虑一下是否是历史文献的传记对象；人物只需要姓名，不要其他的地名、官职等其他内容。
6.事件概要尽量限制在10个字以内。
7.确保原文字段内容不被修改或省略。
8.当某个字段信息不详时，标注为“不详”。
9.仔细检查，不要遗漏事件，务必要全面。只要有不同时间点，就需要分拆开成不同的事件。
...
- 传记对象不出现在这里。
4.最后时间：依据<>中给定的参考时间提取，综合文献片段中的年号、月份、干支日，要尽可能补齐缺失的部分，精确到年号、月份和干支日，不要将时间自行修改为公元纪年方式。不要出现以下的时间错误：
  - "十六年"，没有年号， 应该补全年号："建安十六年"；
  - "建安十八年丙申"，没有月份，应该补全月份："建安十八年五月丙申"；
  - "延康二十五年二月丁卯"，没有干支日，原文："二月丁卯，葬高陵。"，有干支日，应该补全干支日："延康二十五年二月丁卯"。
